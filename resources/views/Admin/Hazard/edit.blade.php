                ...
                <form action="{{ route('admin.manage-hazard.update', $data->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="mb-3 row align-items-center">
                                <label for="hz_code" class="col-sm-4 col-form-label"><b>Select State</b></label>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
									...
									@if($data->hz_image)
                                        ...
                                        <a href="{{ route('admin.file.delete', [
                                                    ...
                                                    'id' => $data->id,
                                                    'column' => 'hz_image',
                                                    'path' => 'assets/uploads/img/hazards/'
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if($data->hz_pdf)
										...
										<a href="{{ route('admin.file.delete', [
												...
												'id' => $data->id,
												'column' => 'hz_pdf',
												'path' => 'assets/uploads/pdf/hazards/'
											]) }}" class="btn btn-danger btn-sm"
											onclick="return confirm('Are you sure you want to delete this file?');">
											<i class="bi bi-trash"></i>
										</a>
                        ...
                        <div class="col-md-5 d-none" id="district-section">
                            ...
                            @endif -->
                            <div class="">
                                <label for="districts" class="col-sm-4 col-form-label"><b>Select Districts</b></label>
    ...
    <script>
        $(document).ready(function(){
            $('#state').change(function(){
                ...
                if(state_id.length > 0){
                    $.ajax({
                        url: '{{ route("admin.get.hazardStateImage") }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            state_id: state_id,
