...
<aside class="col-2 admin-sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a href="{{ route('admin.manage-feedback.index') }}" class="nav-link {{ $currentRoute == 'admin.manage-feedback.index' ? 'active' : '' }}"><i class="bi bi-chat-dots-fill me-2"></i> Manage Feedback</a></li>
        <!-- <li><a href="#" class="nav-link"><i class="bi bi-list-task me-2"></i> Requested Features</a></li> -->
        <li><a href="{{ route('admin.audit-trails.index') }}" class="nav-link {{ $currentRoute == 'admin.audit-trails.index' ? 'active' : '' }}"><i class="bi bi-journal-text me-2"></i> Manage Audit</a></li>
    </ul>
</aside>
