                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-6">
									...
									@if($data->attachment)
                                        <div class="mt-3">
                                            <a href="{{ asset('public/assets/uploads/img/mobileAppContent/' . $data->attachment) }}"
                                                target="_blank">{{ $data->attachment }}</a>

                                            <a href="{{ route('admin.file.delete', [
                                                        'model' => 'MobileAppContent',
                                                        'id' => $data->id,
                                                        'column' => 'attachment',
                                                        'path' => 'assets/uploads/img/mobileAppContent/'
