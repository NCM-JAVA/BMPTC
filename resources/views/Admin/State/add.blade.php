                ...
                <form action="{{ route('admin.manage-state.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-8">
							...
							<div class="mb-3 row align-items-center">
                                <label for="St_pdf" class="col-sm-4 col-form-label"><b>Upload PDF <span
                                            style="color:red">*</span></b></label>
                                <div class="col-sm-6">
                                    <input type="file" name="St_pdf" id="St_pdf" class="form-control">
                                </div>
                            </div>
							<div class="mb-3 row align-items-center">
                                <label for="risk_pdf" class="col-sm-4 col-form-label"><b>Risk Table PDF <span
                                            style="color:red">*</span></b></label>
                                <div class="col-sm-6">
